...
{
    public partial class vistaAlumnosEmprendedores : Form
    {
        public vistaAlumnosEmprendedores()
        {
            InitializeComponent();
        }

        private void vistaAlumnosEmprendedores_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        ...
        {
            FrmEmprendedores form = FrmEmprendedores.GetInstancia();
