...
{
    public partial class vistaAlumnosBecas : Form
    {
        public vistaAlumnosBecas()
        {
            InitializeComponent();
        }
        ...
        private void vistaAlumnos_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        ...
        {
            FrmBecas form = FrmBecas.GetInstancia();
