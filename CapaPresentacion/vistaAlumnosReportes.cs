...
{
    public partial class vistaAlumnosReportes : Form
    {
        public vistaAlumnosReportes()
        {
            InitializeComponent();
        }
        ...
        {
            FrmReportes form = FrmReportes.GetInstancia();
        ...
        private void vistaAlumnosReportes_Load(object sender, EventArgs e)
        {
            this.Mostrar();
