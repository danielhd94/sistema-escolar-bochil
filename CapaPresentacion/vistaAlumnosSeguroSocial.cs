...
{
    public partial class vistaAlumnosSeguroSocial : Form
    {
        public vistaAlumnosSeguroSocial()
        {
            InitializeComponent();
        }
        ...
        {
            FrmSeguro form = FrmSeguro.GetInstancia();
        ...
        private void vistaAlumnosSeguroSocial_Load(object sender, EventArgs e)
        {
            this.Mostrar();
