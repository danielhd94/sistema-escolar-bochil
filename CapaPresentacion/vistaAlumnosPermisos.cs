...
{
    public partial class vistaAlumnosPermisos : Form
    {
        public vistaAlumnosPermisos()
        {
            InitializeComponent();
        }
        ...
        {
            FrmPermisos form = FrmPermisos.GetInstancia();
        ...
        private void vistaAlumnosPermisos_Load(object sender, EventArgs e)
        {
            this.Mostrar();
