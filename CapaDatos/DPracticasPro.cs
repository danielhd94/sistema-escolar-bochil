...
namespace CapaDatos
{
    public class DPracticasPro
    {
        //Variables
        private int _IdPracticasProfesionales;
        ...
        public int IdPracticasProfesionales
        {
            get { return _IdPracticasProfesionales; }
            set { _IdPracticasProfesionales = value; }
        }
        ...
        public DPracticasPro(
            ...
            String textobuscar)
        {
            this.IdPracticasProfesionales = idpracticaspro;
        ...
        //Métodos
        public string Insertar(DPracticasPro practicasPro)
        {
            string rpta = "";
            ...
            try
            {
                ...
                SqlCmd.CommandText = "spinsertar_practicasPro";
                SqlCmd.CommandType = CommandType.StoredProcedure;

                SqlParameter ParIdPracticas = new SqlParameter();
                ParIdPracticas.ParameterName = "@idpracticas";
                ...
                ParNumControl.Value = practicasPro.NumControl;
                ...
                ParaMotivo.Size = 50;
                ParaMotivo.Value = practicasPro.InstitucionSP;
                ...
                ParaFechaInicio.Value = practicasPro.FechaInicio;
                ...
                ParaFechaTermino.Value = practicasPro.FechaTermino;
                ...
                ParaFechaExpConst.Value = practicasPro.FechaExpConst;
                ...
                ParaObservaciones.Value = practicasPro.Observaciones;
        ...
        //Método Editar
        public string Editar(DPracticasPro practicasPro)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "speditar_practicasPro";
                SqlCmd.CommandType = CommandType.StoredProcedure;

                SqlParameter ParIdPracticas = new SqlParameter();
                ParIdPracticas.ParameterName = "@idpracticas";
                ParIdPracticas.SqlDbType = SqlDbType.Int;
                ParIdPracticas.Value = practicasPro.IdPracticasProfesionales;
                SqlCmd.Parameters.Add(ParIdPracticas);
        ...
        //Método Eliminar
        public string Eliminar(DPracticasPro practicasPro)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "speliminar_practicasPro";
                SqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable Mostrar()
        {
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spmostrar_practicasPro";
                SqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        //Método BuscarNombre
        public DataTable BuscarNumControl(DPracticasPro practicasPro)
        {
            DataTable DtResultado = new DataTable("Practicas");
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spbuscar_practicasPro_numcontrol";
                SqlCmd.CommandType = CommandType.StoredProcedure;
                ...
                ParTextoBuscar.Value = practicasPro.TextoBuscar;
